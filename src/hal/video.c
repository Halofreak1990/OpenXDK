...
{
	{ 0x44030307, 640, 480, 50, VIDEO_REGION_PAL }, // 640x480 PAL 50
	{ 0x44040408, 720, 480, 50, VIDEO_REGION_PAL }, // 720x480 PAL 50

	{ 0x0401010B, 640, 480, 60, VIDEO_REGION_PAL }, // 640x480 PAL 60
	{ 0x0402020C, 720, 480, 60, VIDEO_REGION_PAL }, // 720x480 PAL 60

	{ 0x04010101, 640, 480, 60, VIDEO_REGION_NTSCM }, // 640x480 NTSCM 60
	{ 0x04020202, 720, 480, 60, VIDEO_REGION_NTSCM }, // 720x480 NTSCM 60

	{ 0x04010103, 640, 480, 60, VIDEO_REGION_NTSCJ }, // 640x480 NTSCJ 60
	{ 0x04020204, 720, 480, 60, VIDEO_REGION_NTSCJ }, // 720x480 NTSCJ 60
};
